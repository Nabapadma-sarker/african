      ...
      this.$element.find('option').each(function (index) {
        ...
        if (that.options.hideDisabled && (isDisabled && !isOptgroup || isOptgroupDisabled)) {
          ...
          if ($this.data('thumbnail')) {
              ...
              text =
                  '<span class="media">' +
                  '<span class="media-left"><img src="' + $this.data('thumbnail') + '" class="media-object cus_img_size"  onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
