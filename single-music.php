...
//                            $the_query = new WP_Query($arg);
                        ...
                        ?>
                        <?php if (have_rows('music_content')):
                            ?>
                            <?php
                            // loop through rows (parent repeater)
                            while (have_rows('music_content')): the_row();
                                ?>
                                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                                    <?php $large_image_url = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large'); ?>
                                    <img style="width:203px;height:300px;" class="img-responsive img-thumbnail mr-bott10" src="<?php echo $large_image_url[0] ?>" alt="<?php the_title();?>"> 



                        <!--                                    </span> <span class="btn2_wrapper">
                             <a class="btn2 large btn2_text_on launch-share-popover" onclick="">
                                 <span class="btn2_glyph">0</span>
                                 <button class="btn btn-xs btn-danger mr-bott20" type="button">Share...</button>
                             </a>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                    ...
                                    <p class="movies-txt"> <?php the_sub_field('music_duration'); ?> , <?php the_sub_field('music_metascore'); ?></a> </p>
                                    <hr>
                                    ...
                                    <p style="font-size:13px;"><?php the_sub_field('music_description'); ?></p>
                                    <p class="movies-txt"> <strong>Music Director:</strong> <a><?php the_sub_field('music_director'); ?></a> </p>
                                    <p class="movies-txt"> <strong>Singer:</strong> <a><?php the_sub_field('singer'); ?></a> </p>
                                    ...
                                    <div class="dropdown btn-group pull">
                                        ...
                                        <ul style=" top: 0% !important;" class="dropdown-menu">
                                            <li><a href="<?php the_field('facebook_page_link', 18); ?>add-user-dialog" role="button" data-toggle="modal"><i class="fa fa-facebook-square"></i> Facebook</a></li>
                                    ...
                                    while (have_rows('video_content')): the_row(); //                                        
                                        ...
                                        <a href="#" class="" data-toggle="modal" data-target="#videoModal" data-theVideo=" ">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pd-right0">  
                                                <div  class="img-responsive img-rounded" ><?php echo get_sub_field('music_albums'); ?> </div>                                          
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        ...
                                                        <div>
                                                            <iframe width="100%" height="500" src=<?php echo get_sub_field('video_link'); ?>></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
//                                    'order' => 'asc',
                                ...
                                if (have_rows('photo_content')):
                                    ...
                                    while (have_rows('photo_content')): the_row();
                                        ...
                                        ?>  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 pd-right0">
                                            <img class="img-responsive img-rounded" src="<?php echo $image['url']; ?>" alt="photo" />
                                        </div>  
                                        <?php
                                    endwhile;
                                endif;
                                                    ...
                                                    <div>
                                                        <div class="row mr-top20">
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 text-center">
                                                                ...
                                                                <img style="width:220px;height:327px;" class="img-responsive img-thumbnail mr-bott20" src="<?php echo $large_image_url[0] ?>" alt="<?php the_title();?>"> 
                                                            ...
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                                                                ...
                                                                <span class="grery-color"><?php the_sub_field('music_duration'); ?> </span>
                                                                <hr>
                                                                <?php
                                                                if (function_exists('the_ratings')) {
                                                                    the_ratings();
                                                                ...
                                                                <p>&nbsp;</p>
                                                                <p><strong>Director:</strong> <?php the_sub_field('music_director'); ?></p>
                                                                <p><strong>Stars:</strong><?php the_sub_field('singer'); ?></p>
                                                            </div>
                                                        </div>
                                                        <?php $large_image_url = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large'); ?>
                                                        <img style=" height: 134px; width: 94px;" u="thumb" src="<?php echo $large_image_url[0] ?>" alt="<?php the_title();?>"> 
