...
//                                 'parent'=> 32
                        ...
                        ?>
                        <?php if (have_rows('movie_content')):
                        ?>
                        <?php
                        // loop through rows (parent repeater)
                        while (have_rows('movie_content')): the_row();
                        ?>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                            ...
                            <p class="movies-txt"><a> <?php the_sub_field('movie_duration'); ?></a> </p>
                            <hr>
                            ...
                            <p style="font-size:13px;"><?php the_sub_field('movie_description'); ?></p>
                            <p class="movies-txt"> <strong>Director:</strong> <a><?php the_sub_field('movie_director'); ?></a> </p>
                            <p class="movies-txt"> <strong>Stars:</strong> <a><?php the_sub_field('movie_stars'); ?></a> </p>
...
//                                        'order' => 'asc',
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd-right0">
                                                ...
                                                <div>
                                                    <div class="row mr-top20">
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 text-center">
                                                            ...
                                                            <img style="width:220px;height:325px;" class="img-responsive img-thumbnail mr-bott20" src="<?php echo $large_image_url[0] ?>" alt="<?php the_title();?>">
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                                                            ...
                                                            <span class="grery-color"><?php the_sub_field('movie_duration'); ?> </span>
                                                            <hr>
                                                            <?php
                                                            if (function_exists('the_ratings')) {
                                                                the_ratings();
                                                            ...
                                                            <hr>
                                                            <p>
                                                                <?php the_sub_field('movie_description'); ?>
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            <p><strong>Director:</strong> <?php the_sub_field('movie_director'); ?></p>
                                                            <p><strong>Stars:</strong><?php the_sub_field('movie_stars'); ?></p>
                                                        </div>
                                                    </div>
                                                    <?php $large_image_url = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large'); ?>
                                                    <img style=" height: 134px; width: 94px;" u="thumb" src="<?php echo $large_image_url[0] ?>" alt="">
